...
##### Set Title************************************************
st.title("Welcome EPIC ARRAY V1!")
""
...
if submit and data_files is not None:
    ...
    with st.spinner('Fetching EPIC V1 Manifest File'):

        # Get Manifest file
        mani_df=pd.read_csv("EPIC v1 Manifest File.csv",low_memory=False)
